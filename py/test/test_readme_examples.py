# Postcodesio SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PostcodesioSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PostcodesioSDK(...) and PostcodesioSDK.test(...) become
#      PostcodesioSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "postcodesio_sdk"
_SDK_CLASS = "PostcodesioSDK"
...
_ENTITIES = {
    ...
    "Place": "place",
    "Postcode": "postcode",
    "ScottishPostcode": "scottish_postcode",
    "TerminatedPostcode": "terminated_postcode",
}
