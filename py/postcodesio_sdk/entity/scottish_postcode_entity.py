...
from postcodesio_sdk.postcodesio_types import (
    ScottishPostcode,
...
class ScottishPostcodeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ScottishPostcodeEntity(self._client, opts)
    ...
    def data_get(self) -> ScottishPostcode:
    ...
    def match_get(self) -> ScottishPostcode:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ScottishPostcode:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ScottishPostcode().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
