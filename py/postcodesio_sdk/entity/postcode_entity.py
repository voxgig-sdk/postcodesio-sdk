...
class PostcodeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PostcodeEntity(self._client, opts)
    ...
    def create(self, reqdata: PostcodeCreateData, ctrl=None) -> Postcode:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
