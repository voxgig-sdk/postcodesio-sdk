...
from postcodesio_sdk.core.helpers import get_ctx_prop, to_map
...
class PostcodesioContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, PostcodesioSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PostcodesioResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PostcodesioResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PostcodesioError(code, msg, self)
