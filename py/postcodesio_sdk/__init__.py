...
from postcodesio_sdk.utility import register

# Load features
from postcodesio_sdk.feature.base_feature import PostcodesioBaseFeature
from postcodesio_sdk.features import _has_feature, _make_feature
...
class PostcodesioSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "PostcodesioSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PostcodesioSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Nearest(self, data=None) -> "NearestEntity":
        ...
        from postcodesio_sdk.entity.nearest_entity import NearestEntity
    ...
    def Outcode(self, data=None) -> "OutcodeEntity":
        ...
        from postcodesio_sdk.entity.outcode_entity import OutcodeEntity
        return OutcodeEntity(self, data)


    def Place(self, data=None) -> "PlaceEntity":
        """Entity factory: client.Place().list() / client.Place().load({"id": ...})."""
        from postcodesio_sdk.entity.place_entity import PlaceEntity
    ...
    def Postcode(self, data=None) -> "PostcodeEntity":
        ...
        from postcodesio_sdk.entity.postcode_entity import PostcodeEntity
    ...
    def ScottishPostcode(self, data=None) -> "ScottishPostcodeEntity":
        ...
        from postcodesio_sdk.entity.scottish_postcode_entity import ScottishPostcodeEntity
    ...
    def TerminatedPostcode(self, data=None) -> "TerminatedPostcodeEntity":
        ...
        from postcodesio_sdk.entity.terminated_postcode_entity import TerminatedPostcodeEntity
