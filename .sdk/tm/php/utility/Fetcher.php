...
// Postcodesio SDK utility: fetcher

class PostcodesioFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PostcodesioSDK/1.0)';
    ...
    public static function call(PostcodesioContext $ctx, string $fullurl, array $fetchdef): array
    {
