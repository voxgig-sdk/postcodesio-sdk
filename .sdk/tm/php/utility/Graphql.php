...
// Postcodesio SDK utility: graphql
//
...
class PostcodesioGraphql
{
    ...
    // equivalent.
    public static function body(PostcodesioContext $ctx): mixed
    {
    ...
    public static function errors(PostcodesioContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
