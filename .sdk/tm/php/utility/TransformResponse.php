...
// Postcodesio SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PostcodesioTransformResponse
{
    public static function call(PostcodesioContext $ctx): mixed
    {
        ...
        $transform = PostcodesioHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
