...
// Postcodesio SDK streaming feature
...
class PostcodesioStreamingFeature extends PostcodesioBaseFeature
{
    ...
    private function _iterate(PostcodesioResult $result): \Generator
    {
    ...
    private function _streamable(PostcodesioContext $ctx): bool
    {
