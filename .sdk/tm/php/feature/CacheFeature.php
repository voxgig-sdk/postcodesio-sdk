...
class PostcodesioCacheFeature extends PostcodesioBaseFeature
{
    ...
    private function _through(PostcodesioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
