...
// Postcodesio SDK netsim feature
...
class PostcodesioNetsimFeature extends PostcodesioBaseFeature
{
    ...
    private function _simulate(PostcodesioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PostcodesioContext $ctx, array $applied): void
    {
        $client = $this->client;
