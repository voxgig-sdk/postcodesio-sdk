...
{
    private static function utility(): PostcodesioUtility
    {
        return new PostcodesioUtility();
    }
    ...
    private static function ctx(array $over = []): PostcodesioContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PostcodesioContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PostcodesioOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PostcodesioError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PostcodesioOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PostcodesioMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PostcodesioOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PostcodesioMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PostcodesioOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PostcodesioMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PostcodesioSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PostcodesioMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PostcodesioResponse([]),
            'result' => new PostcodesioResult([]),
        ]);
        [, $err] = PostcodesioMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PostcodesioSpec([]),
            'response' => null,
            'result' => new PostcodesioResult([]),
        ]);
        [, $err] = PostcodesioMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PostcodesioSpec(['step' => 's']),
            'response' => new PostcodesioResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PostcodesioResult([]),
        ]);
        [, $err] = PostcodesioMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PostcodesioSpec(['step' => 's']),
            'response' => new PostcodesioResponse(self::resp(200, ['v' => 1])),
            'result' => new PostcodesioResult([]),
        ]);
        [, $err] = PostcodesioMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PostcodesioSpec(['step' => 's']),
            'response' => new PostcodesioResponse(self::resp(200, ['v' => 2])),
            'result' => new PostcodesioResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PostcodesioMakeResponse::call($ctx);
    ...
    {
        $preset = new PostcodesioResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PostcodesioSpec([]),
            'response' => new PostcodesioResponse([]),
            'result' => new PostcodesioResult([]),
        ...
        [$got, $err] = PostcodesioMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PostcodesioResult([])]);
        [, $err] = PostcodesioMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PostcodesioSpec([]), 'result' => null]);
        [, $err] = PostcodesioMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PostcodesioSpec(['step' => 's']),
            'result' => new PostcodesioResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PostcodesioOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PostcodesioMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PostcodesioSpec(['step' => 's']),
            'result' => new PostcodesioResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PostcodesioOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PostcodesioMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PostcodesioResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PostcodesioSpec([]),
            'result' => new PostcodesioResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PostcodesioMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PostcodesioMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PostcodesioError('boom', 'boom');
        $utility->fetcher = function (PostcodesioContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PostcodesioSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PostcodesioMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PostcodesioContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PostcodesioMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PostcodesioResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PostcodesioMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PostcodesioContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PostcodesioSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PostcodesioMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PostcodesioResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PostcodesioSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PostcodesioMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PostcodesioMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PostcodesioMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PostcodesioResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PostcodesioDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PostcodesioResult(['ok' => false])]);
        $this->expectException(PostcodesioError::class);
        PostcodesioDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PostcodesioResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PostcodesioMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PostcodesioMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PostcodesioBaseFeature();
        $b = new PostcodesioBaseFeature();
        PostcodesioFeatureAdd::call($ctx, $a);
        PostcodesioFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PostcodesioBaseFeature
    {
        $f = new PostcodesioBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PostcodesioFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PostcodesioContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PostcodesioSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PostcodesioPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PostcodesioPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PostcodesioResponse(['headers' => null]),
            'result' => new PostcodesioResult([]),
        ]);
        PostcodesioResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PostcodesioResultBody::call($ctx);
