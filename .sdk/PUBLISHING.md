...
|---|---|---|
| `ts/` | @voxgig-sdk/postcodesio-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/postcodesio-sdk \
      --repository voxgig-sdk/postcodesio-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/postcodesio-sdk` shows it, and
`npm trust revoke @voxgig-sdk/postcodesio-sdk --id=<id>` removes it.
