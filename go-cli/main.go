// Command Postcodesio-cli is a CLI + REPL for the Postcodesio SDK,
...
const prompt = "postcodesio"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "nearest outcode place postcode scottish_postcode terminated_postcode"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      POSTCODESIO_APIKEY (api key), POSTCODESIO_BASE (base url override)")
