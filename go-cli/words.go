...
func registerSDKWords(r *eng.Registry, client *sdk.PostcodesioSDK) {
...
func runOp(client *sdk.PostcodesioSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
