// Command Postcodesio-mcp is an MCP server exposing the Postcodesio
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Postcodesio_list  — list records of an entity
//	Postcodesio_load  — load a single record of an entity
//
