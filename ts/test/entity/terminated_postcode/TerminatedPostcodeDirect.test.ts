...
describe('TerminatedPostcodeDirect', async () => {
  ...
  test('direct-load-terminated_postcode', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-terminated_postcode', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POSTCODESIO_TEST_TERMINATED_POSTCODE_ENTID']
