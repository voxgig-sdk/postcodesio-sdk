...
describe('ScottishPostcodeDirect', async () => {
  ...
  test('direct-load-scottish_postcode', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-scottish_postcode', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POSTCODESIO_TEST_SCOTTISH_POSTCODE_ENTID']
