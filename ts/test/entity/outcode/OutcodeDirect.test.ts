...
describe('OutcodeDirect', async () => {
  ...
  test('direct-load-outcode', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-outcode', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POSTCODESIO_TEST_OUTCODE_ENTID']
