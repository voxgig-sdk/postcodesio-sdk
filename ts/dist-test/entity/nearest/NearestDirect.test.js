...
(0, node_test_1.describe)('NearestDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-nearest', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-nearest', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POSTCODESIO_TEST_NEAREST_ENTID'];
...
//# sourceMappingURL=NearestDirect.test.js.map