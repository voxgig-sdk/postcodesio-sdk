...
(0, node_test_1.describe)('OutcodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-outcode', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-outcode', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POSTCODESIO_TEST_OUTCODE_ENTID'];
...
//# sourceMappingURL=OutcodeDirect.test.js.map