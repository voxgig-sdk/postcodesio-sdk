...
(0, node_test_1.describe)('TerminatedPostcodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-terminated_postcode', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-terminated_postcode', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POSTCODESIO_TEST_TERMINATED_POSTCODE_ENTID'];
...
//# sourceMappingURL=TerminatedPostcodeDirect.test.js.map