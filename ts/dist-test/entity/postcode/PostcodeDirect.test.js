...
(0, node_test_1.describe)('PostcodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PostcodesioSDK({
    ...
    (0, node_test_1.test)('direct-load-postcode', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-postcode', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-postcode', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-postcode', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PostcodesioSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['POSTCODESIO_TEST_POSTCODE_ENTID'];
    ...
    const client = new __1.PostcodesioSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PostcodeDirect.test.js.map