...
(0, node_test_1.describe)('PostcodeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'postcode.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != postcode_ref01_data.id);
        // LIST
        const postcode_ref01_match = {};
        const postcode_ref01_list = (await postcode_ref01_ent.list(postcode_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(postcode_ref01_list, { id: postcode_ref01_data.id })));
        // LOAD
        const postcode_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(postcode_ref01_data_dt0.id === postcode_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/postcode/PostcodeTestData.json');
    ...
    let idmap = transform(['postcode01', 'postcode02', 'postcode03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PostcodeEntity.test.js.map