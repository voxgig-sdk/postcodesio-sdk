...
(0, node_test_1.describe)('ScottishPostcodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-scottish_postcode', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-scottish_postcode', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POSTCODESIO_TEST_SCOTTISH_POSTCODE_ENTID'];
...
//# sourceMappingURL=ScottishPostcodeDirect.test.js.map