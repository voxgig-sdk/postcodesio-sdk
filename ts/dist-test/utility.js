...
function envOverride(m) {
    if ('TRUE' === process.env.POSTCODESIO_TEST_LIVE ||
        'TRUE' === process.env.POSTCODESIO_TEST_OVERRIDE) {
    ...
    m.POSTCODESIO_TEST_EXPLAIN = process.env.POSTCODESIO_TEST_EXPLAIN || m.POSTCODESIO_TEST_EXPLAIN;
    return m;
}
