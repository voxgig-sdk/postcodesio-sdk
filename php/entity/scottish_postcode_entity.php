...
// Postcodesio SDK ScottishPostcode entity
...
class ScottishPostcodeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ScottishPostcodeEntity($this->_client, $opts);
    }

    /**
     * @param ScottishPostcode|array $args ScottishPostcode data (assoc-array) to store.
     */
    ...
    /**
     * @return ScottishPostcode|array The current ScottishPostcode data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ScottishPostcode fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ScottishPostcode fields).
     */
     ...
     *
     * @param ScottishPostcodeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ScottishPostcodeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ScottishPostcode|array The loaded ScottishPostcode as an assoc-array at the
