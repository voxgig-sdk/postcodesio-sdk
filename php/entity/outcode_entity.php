...
// Postcodesio SDK Outcode entity
...
class OutcodeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OutcodeEntity($this->_client, $opts);
    }

    /**
     * @param Outcode|array $args Outcode data (assoc-array) to store.
     */
    ...
    /**
     * @return Outcode|array The current Outcode data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Outcode fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Outcode fields).
     */
    ...
    /**
     * Load a single Outcode.
     *
     * @param OutcodeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OutcodeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Outcode|array The loaded Outcode as an assoc-array at the
