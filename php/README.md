...
The PHP SDK for the Postcodesio API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Nearest(null)->list(null, null);
...
[$result, $err] = $client->Postcodesio(null)->load(
    ["id" => "test01"], null
);
