...
class PostcodesioProxyFeature extends PostcodesioBaseFeature
{
    ...
    public function init(PostcodesioContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PostcodesioContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
