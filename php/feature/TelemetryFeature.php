...
// Postcodesio SDK telemetry feature
...
class PostcodesioTelemetryFeature extends PostcodesioBaseFeature
{
    ...
    private function _close(PostcodesioContext $ctx, bool $ok): void
    {
