...
// Postcodesio SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PostcodesioTestFeature extends PostcodesioBaseFeature
{
    ...
    public function init(PostcodesioContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PostcodesioContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PostcodesioParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PostcodesioContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PostcodesioContext $ctx, $op, $args): array
    {
