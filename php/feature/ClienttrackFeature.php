...
// Postcodesio SDK clienttrack feature
...
class PostcodesioClienttrackFeature extends PostcodesioBaseFeature
{
    ...
    public function PostConstruct(PostcodesioContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Postcodesio-SDK';
