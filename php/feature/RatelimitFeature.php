...
// Postcodesio SDK ratelimit feature
...
class PostcodesioRatelimitFeature extends PostcodesioBaseFeature
{
    ...
    private function _acquire(PostcodesioContext $ctx): void
    {
    ...
    private function _track(PostcodesioContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
