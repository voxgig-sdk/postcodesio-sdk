...
// Postcodesio SDK timeout feature
...
class PostcodesioTimeoutFeature extends PostcodesioBaseFeature
{
    ...
    private function _with_timeout(PostcodesioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PostcodesioContext $_ctx, float $ms): void
    {
        $client = $this->client;
