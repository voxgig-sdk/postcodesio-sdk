...
// Postcodesio SDK metrics feature
...
class PostcodesioMetricsFeature extends PostcodesioBaseFeature
{
    ...
    private function _record(PostcodesioContext $ctx, bool $ok): void
    {
