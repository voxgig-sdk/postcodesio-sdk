...
class PostcodesioRbacFeature extends PostcodesioBaseFeature
{
    ...
    private function _required(PostcodesioContext $ctx): ?string
    {
    ...
    private function _reject(PostcodesioContext $ctx, string $required): void
    {
    ...
    private function _track(PostcodesioContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
