...
// Postcodesio SDK idempotency feature
...
class PostcodesioIdempotencyFeature extends PostcodesioBaseFeature
{
    ...
    private function _mutating(PostcodesioContext $ctx): bool
    {
