...
class ScottishPostcodeDirectTest extends TestCase
{
    public function test_direct_load_scottish_postcode(): void
    {
        $setup = scottish_postcode_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-scottish_postcode", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
