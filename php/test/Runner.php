...
class PostcodesioTestRunner
{
    ...
    {
        $live = self::getenv('POSTCODESIO_TEST_LIVE');
        $override = self::getenv('POSTCODESIO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('POSTCODESIO_TEST_EXPLAIN');
...
class_alias('PostcodesioTestRunner', 'Runner');
class_alias('PostcodesioHelpers', 'Helpers');
