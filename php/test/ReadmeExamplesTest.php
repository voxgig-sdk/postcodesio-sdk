...
// Postcodesio SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PostcodesioSDK::test)
...
{
    private const SDK_CLASS = 'PostcodesioSDK';
    ...
    private const SDK_BASE = 'postcodesio_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../postcodesio_sdk.php';
