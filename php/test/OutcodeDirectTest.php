...
class OutcodeDirectTest extends TestCase
{
    public function test_direct_load_outcode(): void
    {
        $setup = outcode_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-outcode", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
