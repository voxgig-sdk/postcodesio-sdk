...
// Postcodesio SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PostcodesioOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PostcodesioOmni::structfix($now, Struct::undef()))
                        !== json_encode(PostcodesioOmni::structfix($val, Struct::undef()))) {
