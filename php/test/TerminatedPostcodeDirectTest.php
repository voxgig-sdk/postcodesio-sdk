...
class TerminatedPostcodeDirectTest extends TestCase
{
    public function test_direct_load_terminated_postcode(): void
    {
        $setup = terminated_postcode_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-terminated_postcode", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
