...
local ScottishPostcodeEntity = {}
ScottishPostcodeEntity.__index = ScottishPostcodeEntity


function ScottishPostcodeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ScottishPostcodeEntity)
  self._name = "scottish_postcode"
  self._client = client
...
function ScottishPostcodeEntity:get_name()
  return self._name
end


function ScottishPostcodeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ScottishPostcodeEntity.new(self._client, opts)
end
...
function ScottishPostcodeEntity:mark_deleted()
  self._deleted = true
end


function ScottishPostcodeEntity:deleted()
  return true == self._deleted
end


function ScottishPostcodeEntity:data_set(args)
  if args ~= nil then
...
function ScottishPostcodeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ScottishPostcodeEntity:match_set(args)
  if args ~= nil then
...
function ScottishPostcodeEntity:match_get()
...
function ScottishPostcodeEntity:stream(action, args, callopts)
...
function ScottishPostcodeEntity:_run_op(ctx, post_done)
  local utility = self._utility
