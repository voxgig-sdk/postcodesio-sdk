...
describe("ScottishPostcodeDirect", function()
  it("should direct-load-scottish_postcode", function()
    local setup = scottish_postcode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-scottish_postcode", setup.live and "live" or "unit")
...
function scottish_postcode_direct_setup(mockres)
