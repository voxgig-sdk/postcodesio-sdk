...
local SDK_MODULE = "postcodesio_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["nearest"] = { ["test01"] = { id = "test01" } }, ["outcode"] = { ["test01"] = { id = "test01" } }, ["place"] = { ["test01"] = { id = "test01" } }, ["postcode"] = { ["test01"] = { id = "test01" } }, ["scottish_postcode"] = { ["test01"] = { id = "test01" } }, ["terminated_postcode"] = { ["test01"] = { id = "test01" } } } }'
