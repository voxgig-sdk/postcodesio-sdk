...
describe("OutcodeDirect", function()
  it("should direct-load-outcode", function()
    local setup = outcode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-outcode", setup.live and "live" or "unit")
...
function outcode_direct_setup(mockres)
