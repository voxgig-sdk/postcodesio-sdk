...
describe("TerminatedPostcodeDirect", function()
  it("should direct-load-terminated_postcode", function()
    local setup = terminated_postcode_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-terminated_postcode", setup.live and "live" or "unit")
...
function terminated_postcode_direct_setup(mockres)
