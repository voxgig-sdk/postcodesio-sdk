...
class NearestEntity
  ...
  def make
    opts = @_entopts.dup
    NearestEntity.new(@_client, opts)
  end
  ...
  # @return [Nearest, Hash] the current Nearest data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Nearest fields)
  def match_get
  ...
  #
  # @param reqmatch [NearestListMatch, Hash, nil] match filter (any subset of
  #   Nearest fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Nearest>, Array] the matching Nearest items; raises PostcodesioError on failure
