...
module PostcodesioTestRunner
  ...
  def self.env_override(m)
    live = getenv("POSTCODESIO_TEST_LIVE")
    override = getenv("POSTCODESIO_TEST_OVERRIDE")
    ...
    explain = getenv("POSTCODESIO_TEST_EXPLAIN")
    m["POSTCODESIO_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PostcodesioTestRunner
Helpers = PostcodesioHelpers
Vs = VoxgigStruct
