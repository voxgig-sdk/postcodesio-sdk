...
The Golang SDK for the Postcodesio API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/postcodesio-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/postcodesio-sdk=../path/to/github.com/voxgig-sdk/postcodesio-sdk
```
...
```
github.com/voxgig-sdk/postcodesio-sdk/
...
The root package (`github.com/voxgig-sdk/postcodesio-sdk`) re-exports everything needed
