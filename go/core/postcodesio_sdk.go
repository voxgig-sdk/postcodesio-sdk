...
func (sdk *PostcodesioSDK) OptionsMap() map[string]any {
...
func (sdk *PostcodesioSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PostcodesioSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PostcodesioSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PostcodesioSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PostcodesioSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PostcodesioSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PostcodesioSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PostcodesioSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PostcodesioSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PostcodesioSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
