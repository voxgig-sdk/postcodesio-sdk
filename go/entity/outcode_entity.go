...
func NewOutcodeEntity(client *core.PostcodesioSDK, entopts map[string]any) *OutcodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OutcodeEntity) GetName() string { return e.name }
...
func (e *OutcodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OutcodeEntity) Deleted() bool {
	return e.deleted
}


func (e *OutcodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOutcodeEntity(e.client, opts)
}

func (e *OutcodeEntity) Data(args ...any) any {
...
func (e *OutcodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Outcode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OutcodeEntity) DataTyped(data ...Outcode) Outcode {
	if len(data) > 0 {
		return typedFrom[Outcode](e.Data(asMap(data[0])))
	}
	return typedFrom[Outcode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Outcode (all fields
// optional at the wire level).
func (e *OutcodeEntity) MatchTyped(match ...Outcode) Outcode {
	if len(match) > 0 {
		return typedFrom[Outcode](e.Match(asMap(match[0])))
	}
	return typedFrom[Outcode](e.Match())
}
...
func (e *OutcodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OutcodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OutcodeLoadMatch and returns an Outcode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OutcodeEntity) LoadTyped(reqmatch OutcodeLoadMatch, ctrl map[string]any) (Outcode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Outcode{}, err
	}
	return typedFrom[Outcode](res), nil
}



func (e *OutcodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OutcodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OutcodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OutcodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OutcodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
