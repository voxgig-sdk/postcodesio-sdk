...
func NewPostcodeEntity(client *core.PostcodesioSDK, entopts map[string]any) *PostcodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PostcodeEntity) GetName() string { return e.name }
...
func (e *PostcodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PostcodeEntity) Deleted() bool {
	return e.deleted
}


func (e *PostcodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPostcodeEntity(e.client, opts)
}

func (e *PostcodeEntity) Data(args ...any) any {
...
func (e *PostcodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Postcode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PostcodeEntity) DataTyped(data ...Postcode) Postcode {
	if len(data) > 0 {
		return typedFrom[Postcode](e.Data(asMap(data[0])))
	}
	return typedFrom[Postcode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Postcode (all fields
// optional at the wire level).
func (e *PostcodeEntity) MatchTyped(match ...Postcode) Postcode {
	if len(match) > 0 {
		return typedFrom[Postcode](e.Match(asMap(match[0])))
	}
	return typedFrom[Postcode](e.Match())
}
...
func (e *PostcodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PostcodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PostcodeLoadMatch and returns an Postcode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PostcodeEntity) LoadTyped(reqmatch PostcodeLoadMatch, ctrl map[string]any) (Postcode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Postcode{}, err
	}
	return typedFrom[Postcode](res), nil
}




func (e *PostcodeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PostcodeListMatch and returns []Postcode. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PostcodeEntity) ListTyped(reqmatch PostcodeListMatch, ctrl map[string]any) ([]Postcode, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Postcode](res), nil
}




func (e *PostcodeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PostcodeCreateData and returns an Postcode. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PostcodeEntity) CreateTyped(reqdata PostcodeCreateData, ctrl map[string]any) (Postcode, error) {
...
func (e *PostcodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PostcodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PostcodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
