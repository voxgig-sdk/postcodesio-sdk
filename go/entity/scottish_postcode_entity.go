...
type ScottishPostcodeEntity struct {
	name    string
...
func NewScottishPostcodeEntity(client *core.PostcodesioSDK, entopts map[string]any) *ScottishPostcodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScottishPostcodeEntity) GetName() string { return e.name }
...
func (e *ScottishPostcodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScottishPostcodeEntity) Deleted() bool {
	return e.deleted
}


func (e *ScottishPostcodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScottishPostcodeEntity(e.client, opts)
}

func (e *ScottishPostcodeEntity) Data(args ...any) any {
...
func (e *ScottishPostcodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ScottishPostcode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScottishPostcodeEntity) DataTyped(data ...ScottishPostcode) ScottishPostcode {
	if len(data) > 0 {
		return typedFrom[ScottishPostcode](e.Data(asMap(data[0])))
	}
	return typedFrom[ScottishPostcode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ScottishPostcode (all fields
// optional at the wire level).
func (e *ScottishPostcodeEntity) MatchTyped(match ...ScottishPostcode) ScottishPostcode {
	if len(match) > 0 {
		return typedFrom[ScottishPostcode](e.Match(asMap(match[0])))
	}
	return typedFrom[ScottishPostcode](e.Match())
}
...
func (e *ScottishPostcodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScottishPostcodeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScottishPostcodeLoadMatch and returns an ScottishPostcode. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ScottishPostcodeEntity) LoadTyped(reqmatch ScottishPostcodeLoadMatch, ctrl map[string]any) (ScottishPostcode, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ScottishPostcode{}, err
	}
	return typedFrom[ScottishPostcode](res), nil
}



func (e *ScottishPostcodeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ScottishPostcodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScottishPostcodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScottishPostcodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScottishPostcodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
