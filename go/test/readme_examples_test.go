...
const testSeed = `map[string]any{"entity": map[string]any{"nearest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "outcode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "postcode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "scottish_postcode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "terminated_postcode": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
